...
19. Когда вся координата X заполнится квадратами фигур, то очищать ее и опускать все верхние фигуры вниз []
    - Очищать список от квадратов [x]
    - Опускать верхние квадраты вниз []
20. Фигуры должны переворачиваться (исходная фигура при первом рендере может перевернуться) []
21. При удалении квадратов прибавлять очки []
